            ...
            <div class="row">
                ...
                <div class="card" style="background-color:rgba(211, 211, 211, 0.8) ;">
                    ...
                    <table class="table table-striped">
                        ...
                        <p>
                            <a class='btn btn-secondary' role='button' type='button' data-bs-toggle="collapse" data-bs-target="#collapsemuziek" aria-controls="collapsemuziek" aria-expanded="false">
                    ...
                    <div id="carouselExampleSlidesOnly" class="carousel slide " data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="./images/image150.jpg" class="max-height-150px max-width-150px" alt="...">
                            </div>
                            <?php
                            ...
                            foreach ($result as $row) { ?>
                                ...
                                <div class="carousel-item">
                                    <img src="<?php echo $row['SponsorLogo'] ?>" style="height: 150px; width: 150px;">
                                </div>
                            <?php } ?>
                        </div>
                    </div>
                ...
                ?>
                    ...
                    foreach ($result as $row) { ?>
                        <div class="col-md-3 col-sm-12 mt-4">
                            <div class="card">
                                <img src="<?php echo $row['JuryLogo'] ?>" style="max-height: 300px;" class="card-img-top" alt="...">
                                <div class="card-body">
                                    ...
                                    if (is_null($row['JuryWebsite'])) {
                                        ...
                                        <p>
                                            <a href="<?php echo $row['JuryWebsite'] ?>" target='_blank'><button type='button' class="btn-secondary">Website</button></a>
                                        </p>
                                    <?php } ?>
